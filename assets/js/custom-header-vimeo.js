(function( window, wp ) {
	...
	var VimeoLegacyHandler = wp.customHeader.BaseVideoHandler.extend({
		...
		ready: function() {
			...
			iframe.src = 'https://player.vimeo.com/video/' + videoId + '?api=1&autopause=0&autoplay=1&loop=1&background=1&badge=0&byline=0&player_id=' + iframe.id + '&portrait=0&title=0';
			this.iframe = iframe;
